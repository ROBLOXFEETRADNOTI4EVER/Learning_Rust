...
pub async  fn read_user(pool:&sqlx::PgPool,user_id:i32) -> Result<BUSER, sqlx::Error>{
...
pub async  fn find_user_fullpool(pool : &sqlx::PgPool, name: &str)-> Result<Vec<BUSER>, sqlx::Error>{
